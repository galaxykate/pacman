...
public class Executor {
	...
	public void runUnitTests(Controller<MOVE> pacManController,
			Controller<EnumMap<GHOST, MOVE>> ghostController) {
		Random rnd = new Random(0);
		Game game;
		EnumMap<GHOST, MOVE> moves;

		// pac man is 5 units down from blinky, blinky is edible, blinky should
		// move up
		game = new Game(rnd.nextLong(), 0);
		moves = ghostController.getMove(game.copy(), System.currentTimeMillis()
				+ DELAY);
